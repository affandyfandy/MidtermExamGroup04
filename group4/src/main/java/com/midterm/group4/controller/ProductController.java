...
public class ProductController {
    ...
    public ResponseEntity<ProductDTO> productActivation(@Parameter(description = "Product ID") @PathVariable UUID id){
    ...
    public ResponseEntity<ProductDTO> productDeactivate(@Parameter(description = "Product ID") @PathVariable UUID id){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ProductDTO> updateProduct(@Parameter(description = "Product ID") @PathVariable UUID id, @Parameter(description = "Product DTO") @RequestBody ProductDTO dto){
    ...
    @PostMapping
    public ResponseEntity<ProductDTO> addNewProduct(@Parameter(description = "Product DTO") @RequestBody ProductDTO productDto) {
    ...
    @PostMapping("/import")
    public ResponseEntity<List<ProductDTO>> importProduct(@Parameter(description = "Excel file") @RequestParam("file") MultipartFile file) throws IOException {
        List<ProductDTO> listProductDto = FileUtils.readEmployeeFromExcel(file);
        List<Product> listProduct = productMapper.toListEntity(listProductDto);
        List<Product> savedListProduct = productService.saveAll(listProduct);
        return ResponseEntity.status(HttpStatus.ACCEPTED).body(productMapper.toListDto(savedListProduct));
    }
}
